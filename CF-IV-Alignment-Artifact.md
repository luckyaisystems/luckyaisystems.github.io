...
**Status:** Equinix Workforce Development Launchpad Intern (Jul 2026 – Present)  
**Education:** Building Systems Engineering Technician @ Seneca Polytechnic (Sustainability & Energy Efficiency)
...
## 4. Educational Alignment (Seneca Polytechnic)
| Coursework | Job Relevance |
|------------|---------------|
| Building Systems Engineering Technician | Direct match to Preferred Qualifications |
| HVAC/R, Air Handling | Matches thermal & mechanical systems requirements |
| AutoCAD, Revit, Energy Modeling | Supports technical documentation interpretation |
| Sustainability & Energy Efficiency | Aligns with energy efficiency initiatives |

---

## 5. Identified Gaps & Mitigation

| Gap | Severity | Mitigation Strategy |
|-----|----------|---------------------|
| 2–4 years corporate experience (currently internship-level) | 🔴 High | Leverage internship duration + Seneca lab hours as applied experience |
| Vendor coordination exposure (not yet documented) | 🟡 Medium | Document interactions during internship in evidence log |
| Formal HVAC/Electrical certifications | 🟡 Medium | Pursue vocational certificates noted in Preferred Qualifications |
...
- [ ] Site learning reflections
- [ ] Vendor coordination observations

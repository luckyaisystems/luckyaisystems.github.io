...
| Scenario | Probability | Early Warning Signs | Mitigation Strategy |
|----------|-------------|---------------------|---------------------|
| **Internship → conversion rejection** | Low | No conversion talk by Week 8 | Ask manager in Week 6; prepare backup employer list |
| **Semester 3 burnout (heavy in-person load)** | High | <6hr sleep for 7+ nights, irritability, grade decline | Request night shift (June 2027); reduce course load if needed |
| **BJO funding blocks program extension** | Medium | Course conflict warnings | Finish Semester 4 concurrently; maintain minimum credit load |
| **Old gambling pattern reactivation** | Medium | Skipping savings deposits, checking crypto/betting apps | Remove apps; monthly accountability check-in |
...
|--------|--------|-------------|
| **Sleep consistency** | ≥6.5hr for 5+ nights/week | 3+ weeks below target |
